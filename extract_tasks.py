...
def get_monthly_data(start_date, end_date):
    page = 1
    tasks_url = f"https://api.us.lighthouse.io/applications/64788f940b7634da94ffdcbd/tasks/entries?from={start_date}&to={end_date}&page={page}&perPage=50&sort=-createdAt"
    all_data = []
    
    while True:
        data = get_task_data(tasks_url)
